...
۴                                   & مدیر فنی شرکت & نقشی که بررسی مشکلات فنی سامانه را برعهده دارد.  
 ...
 5                                  & کاربر عادی         & شامل دو کنشگر مشتری و متخصص است که نقش مدیریتی در سامانه ندارند.\\ 
 \hline
 
 ۶                                  & کاربر مدیر         & شامل دو کنشگر مدیر شرکت و مدیر فنی شرکت است که نقش مدیریتی در سامانه دارند.\\ 
...
% main flow
{
	\vspace*{-0.6cm}
	\begin{enumerate}
		\item مورد کاربرد هنگام درخواست کاربر مدیر برای مشاهده تاریخچه خدمات شروع می‌شود.
		\item 
...
% main flow
{
	...
	\begin{enumerate}
		\item 
		مورد کاربرد هنگام درخواست کاربر برای مشاهده تاریخچه خدمات شروع می‌شود.
		\item
...
کاربر مدیر درخواست مشاهده گزارشات مشکلات فنی را می‌دهد.
			\item
سیستم گزارشات فنی را به ترتیب تاریخ جمع‌آوری می‌کند.
			\item
