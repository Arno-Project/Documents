...
\begin{center}
	\begin{singlespace}	\begin{longtable}{|m{0.18\linewidth}|m{0.82\linewidth}|} 
			...
			\changelogEntry{5/20}{بروزرسانی زمان‌بندی}
			\changelogEntry{5/28}{بروزرسانی نیازمندی‌ها و موارد کاربرد ‌}
			\changelogEntry{5/30}{اضافه کردن نمودار استقرار  ‌}					
			\changelogEntry{5/30}{اضافه کردن مستند استفاده  ‌}					
			\changelogEntry{5/30}{اضافه کردن مستند نصب  ‌}			
			\changelogEntry{5/31}{اضافه کردن چک‌لیست  ‌}					
			\changelogEntry{5/31}{ویرایش نسخه‌ی نهایی مستند  ‌}					
