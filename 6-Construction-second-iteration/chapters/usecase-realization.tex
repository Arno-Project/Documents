...
\begin{table}[ht!]
	...
	\begin{tabular}{|p{0.1\linewidth}|p{0.35\linewidth}|p{0.45\linewidth}|} 
		...
		\usecasecrcitem{دریافت لیست مرتب‌شده‌ی متخصصان}{ کاتالوگ کاربر، کاربر مدیر}
...
\usecasecrcitem{تعیین امتیاز مورد نیاز برای پذیرش درخواست}{کاتالوگ امتیاز لازم پذیرش درخواست، امتیاز لازم پذیرش درخواست، مدیر شرکت}
