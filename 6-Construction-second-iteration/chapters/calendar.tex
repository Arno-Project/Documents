...
\begin{singlespace}
	\begin{table}[ht!]
		...
		\begin{tabular}{|p{0.07\linewidth}|p{0.35\linewidth}|p{0.1\linewidth}|p{0.15\linewidth}|p{0.15\linewidth}|p{0.07\linewidth}|} 
			...
			\hline
			شناسه & نام وظیفه & تخمین (نفر-روز) & شروع & پایان & پیش‌نیاز\\
			\hline
			\calendarEntry
			{1.1}
...
\begin{table}[h]
	...
	\begin{tabular}{|p{0.07\linewidth}|p{0.45\linewidth}|p{0.13\linewidth}|p{0.25\linewidth}|} 
		...
		\hline
		شناسه & نام وظیفه & تخمین (نفر-روز) & مسئول\\
		\hline
...
\begin{figure}[H]
	...
	\begin{center}
		\begin{ganttchart}[
			...
			\ganttbar[progress=0, name=check]{\rl{استخراج چک‌لیست از اسلایدهای درس}}{20}{22} \\
			
			\ganttgroup{\rl{نیازمندی‌ها}}{20}{27} \\
			\ganttbar[progress=0, name=sched]{\rl{بروزرسانی زمان‌بندی}}{20}{20} \\
			\ganttbar[progress=0, name=update]{\rl{بروزرسانی نیازمندی‌ها و موارد کاربرد با توجه به لیست جدید}}{20}{22} \\
			\ganttbar[progress=0, name=interface, bar right shift=-0.5]{\rl{تهیه‌ی واسط کاربری قابل اجرا‌}}{20}{22} \\
			\ganttbar[progress=0, name=interface2, bar right shift=-0.5]{\rl{‌نهایی کردن واسط کاربری قابل اجرا}}{25}{27} \\
			\ganttbar[progress=0, name=interface3, bar left shift=0.5]{\rl{تهیه تصاویر از واسط کاربری قابل اجرا}}{27}{27} \\
		
			\ganttgroup[name=analyze]{\rl{تحلیل}}{23}{28} \\
			\ganttbar[progress=0, name=update2]{\rl{بروزرسانی و اصلاح محصولات تحلیل تکرار قبل}}{23}{24} \\
			\ganttbar[progress=0, name=pack]{\rl{بروزرسانی زیرسیستم‌ها و پیدا کردن بسته‌های سیستم‌}}{24}{24} \\						
			\ganttbar[progress=0, name=class1]{\rl{بروزرسانی کلاس‌ها‌}}{24}{24} \\						
			\ganttbar[progress=0, name=activity]{\rl{تهیه‌ی نمودارهای فعالیت با خطوط شنا}}{25}{26} \\
			\ganttbar[progress=0, name=seq]{\rl{تهیه‌ی نمودارهای توالی‌}}{25}{26} \\
			\ganttbar[progress=0, name=class2]{\rl{تهیه‌ی نمودار کلاس‌های تحلیل}}{27}{27} \\			
			\ganttbar[progress=0, name=realization]{\rl{بروزرسانی تحقق موارد کاربرد‌}}{28}{28} \\
			\ganttbar[progress=0, name=packDia]{\rl{تهیه‌ی نمودار بسته‌}}{28}{28} \\
			
			
			\ganttgroup{\rl{آزمون}}{29}{30} \\
			\ganttbar[progress=0, name=test, bar right shift=-0.5]{\rl{ارزیابی دستاوردها}}{29}{30} \\			
			\ganttbar[progress=0]{\rl{تکمیل مستندات}}{29}{30} \\
			
			%relations 
			
			\ganttlink{interface}{interface2} 
			\ganttlink{interface2}{interface3} 
			\ganttlink[link mid=0.1]{check}{test} 
...
\begin{table}[h]
	...
	\begin{tabular}{|p{0.07\linewidth}|p{0.45\linewidth}|p{0.13\linewidth}|p{0.25\linewidth}|} 
		...
		\calendarEntryWithName
		{3.3}
		{بروزرسانی نیازمندی‌ها و موارد کاربرد با توجه به لیست جدید}
		{1}
		{صبا هاشمی}
		\calendarEntryWithName
		{4.3}
		...
		\calendarEntryWithName
		{5.3}
		{نهایی کردن واسط کاربر قابل اجرا}
		{2}
		{علیرضا تاج‌میرریاحی}
...
\begin{figure}[H]
	...
	\begin{center}
		\begin{ganttchart}[
			...
			\ganttgroup{\rl{پیاده‌سازی}}{6}{13} \\			
			\ganttbar[progress=0, name=back]{\rl{بکند نمونه اولیه تکامل یافته سیستم‌}}{6}{10} \\
			\ganttbar[progress=0, name=front]{\rl{فرانت‌اند نمونه اولیه تکامل یافته سیستم‌}}{8}{13} \\			
			
			\ganttgroup{\rl{آزمون}}{14}{14} \\
			\ganttbar[progress=0, name=test]{\rl{ارزیابی دستاوردها}}{14}{14} \\			
			\ganttbar[progress=0]{\rl{تکمیل مستندات}}{14}{14} \\
			
			%relations 
			
	
			\ganttlink[link mid=0.1]{check}{test} 
				\ganttlink[link mid=0.1]{class}{olgo} 		
				\ganttlink[link mid=0.1]{class}{db} 		
			%			\ganttvrule[vrule/.append style={blue, thin},vrule offset=1]{\rl{گزارش اول}}{6}
...
\begin{figure}[H]
	...
	\begin{center}
		\begin{ganttchart}[
			...
			\ganttbar[progress=0, name=check]{\rl{استخراج چک‌لیست از اسلایدهای درس}}{14}{15} \\
			
			\ganttgroup{\rl{نیازمندی‌ها}}{14}{20} \\
			\ganttbar[progress=0, name=sched]{\rl{بروزرسانی زمان‌بندی}}{14}{14} \\
			\ganttbar[progress=0, name=update]{\rl{بروزرسانی و اصلاح محصولات نیازمندی تکرار قبل}}{14}{16}\\
			\ganttbar[progress=0, name=update]{\rl{بروزرسانی اولویت‌ها و ریسک‌ها}}{14}{16}\\
			\ganttbar[progress=0, name=update]{\rl{نسخه‌ی تکمیل شده‌ی بررسی تحقق موارد کاربرد}}{16}{20}\\
			
			\ganttgroup{\rl{طراحی‌}}{15}{16} \\			
			\ganttbar[progress=0, name=class]{\rl{تهیه‌ی نمودار استقرار}}{15}{16} \\			
			
			\ganttgroup{\rl{پیاده‌سازی}}{15}{31} \\			
			\ganttbar[progress=0, name=back]{\rl{بکند نسخه‌ی نهایی سیستم‌}}{15}{30} \\
			\ganttbar[progress=0, name=front]{\rl{فرانت‌اند نسخه‌ی نهایی سیستم‌}}{15}{30} \\			
			\ganttbar[progress=0, name=doc1]{\rl{تهیه‌ی مستند نصب سیستم‌}}{30}{31} \\			
			\ganttbar[progress=0, name=doc2]{\rl{تهیه‌ی مستند استفاده از سیستم‌}}{30}{31} \\			
			
			\ganttgroup{\rl{آزمون}}{30}{31} \\
			\ganttbar[progress=0, name=test]{\rl{ارزیابی دستاوردها}}{31}{31} \\			
			\ganttbar[progress=0, name=test]{\rl{درستی‌سنجی }}{31}{31} \\		
			\ganttbar[progress=0]{\rl{تکمیل مستندات}}{30}{31} \\
...
\begin{table}[h]
	...
	\begin{tabular}{|p{0.07\linewidth}|p{0.35\linewidth}|p{0.1\linewidth}|p{0.15\linewidth}|p{0.15\linewidth}|} 
		...
		\hline
		شناسه & نام وظیفه & تخمین (نفر-روز) & شروع & پایان\\
		\hline
