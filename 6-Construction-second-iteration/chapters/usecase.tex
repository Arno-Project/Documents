...

{
	...
	\cancelAlternativeFlow{جست‌وجو و مشاهده تخصص‌ها}{مشتری}{1}{فرآیند جست‌وجو و مشاهده ‌تخصص‌ها لغو می‌شود.}
}
...
{}
% brief description
{کاربر می‌توانند لیست مرتب‌شده‌ی متخصصان را بر حسب امتیازشان مشاهده کند.}
% primary actors
{کاربر مدیر}
% secondary actors
{}
...
% main flow
{
	...
	\begin{enumerate}
		\item 
		مورد کاربرد هنگام درخواست کاربر مدیر برای مشاهده متخصصان شروع می‌شود.
		\item
...
% دریافت پیشنهادات و انتقادات غیر فنی
{
	\usecase
	% name
	{دریافت پیشنهادات و انتقادات غیر فنی}
	...
	{}
	% brief description
	{مدیر شرکت می‌تواند پیشنهادات و انتقادات سیستم را دریافت کند.}
	% primary actors
	{مدیر شرکت}
	% secondary actors
	{}
	...
	% main flow
	{
		...
		\begin{enumerate}
			\item 
کاربر مدیر درخواست مشاهده پیشنهادات و انتقادات را می‌دهد.
			\item
سیستم گزارشات غیر فنی را از بین پیشنهادات و انتقادات دریافت شده بر حسب نوع درخواست به ترتیب تاریخ جمع‌آوری می‌کند.
		\end{enumerate}
	}
	% postconditions
	{
گزارش پیشنهادات و انتقادات به کاربر مدیر نشان داده شده باشد.	
}
	% alternative flows
	{
	...
	% table name
	{
	مورد کاربرد:	دریافت پیشنهادات و انتقادات غیر فنی
	}
