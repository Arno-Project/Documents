...
% مشاهده‌ی پیام‌ها
{
	...
	% main flow
	{
		...
		\begin{enumerate}
			\item 
			مورد کاربرد با انتخاب «مشاهده‌ی پیام‌ها» در صفحه‌ی مشاهده‌ی درخواست‌ها توسط کاربر آغاز می‌شود.
			\item
			تمام پیام‌های ارسال شده و دریافت شده به کاربر مورد نظر نمایش داده می‌شود.
		\end{enumerate}
	}
	% postconditions
