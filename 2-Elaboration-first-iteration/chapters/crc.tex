...
علاوه بر آن برای هر کارت کلاس پدر، کلاس‌های فرزند و صفات اصلی که در کلاس نگه‌داری می‌شوند اشاره شده‌اند. با توجه به این که نکات اساسی که باید در کارت‌های CRC ذکر شود، مسئولیت‌ها و کلاس‌های همکار هستند، مجموعه صفات ذکر شده کامل نیستند و در نمودار کلاس دقیق می‌شوند.
