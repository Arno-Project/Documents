...
{}
% brief description
{کابران عادی می‌توانند مشکلات فنی مربوط به سیستم را گزارش کنند.}
% primary actors
{کاربر عادی}
% secondary actors
{}
...
% main flow
{
	...
	\begin{enumerate}
		\item 
		مورد کاربرد هنگام درخواست کاربر برای گزارش مشکل شروع می‌شود.
		\item
		کاربر عنوان و توضحیات مربوط به مشکل را وارد می‌کند.
		\item
		کاربر اطلاعات وارد شده را تایید می‌کند.
		\item
		سیستم ثبت موفق مشکل را به کاربر گزارش می‌کند.
	\end{enumerate}
}
% postconditions
{گزارش داده شده در صف گزارش‌های بررسی نشده توسط مدیر فنی قرار می‌گیرد.}
% alternative flows
{
}
% table name
