...
% main flow
{
	...
	\begin{enumerate}
		...
		\begin{enumerate}[label=\theenumi.\arabic*.]
			\item
			شامل (Include) مورد کاربری «مشاهده جزئیات خدمت»
		\end{enumerate}
...
\cancelAlternativeFlow{فیلتر و مرتب کردن درخواست‌ها}{متخصص}{1}{فرآیند فیلتر و مرتب کردن درخواست‌ها لغو می‌شود.}
}
...
\cancelAlternativeFlow{مشاهده خدمات درخواست شده}{مشتری}{1}{فرآیند مشاهده خدمات درخواست شده لغو می‌شود.}
}
...

{
	...
	{مورد کاربرد: مشاهده جزئیات خدمت}
	
	\alternativeflow
	% name
	{
		مشاهده جزئیات خدمت:وجود‌ نداشتن آی‌دی‌
	}
	% id
	{1.3}
	% brief description
	...
	% table name
	{
		روند جایگزین: مشاهده جزئیات خدمت:وجود‌ نداشتن آی‌دی‌
	}
}
...
% پذیرش درخواست مشتری
{
	...
	% table name
	{
		مورد کاربرد: پذیرش درخواست مشتری
	}
	
	\alternativeflow
	% name
	{
		پذیرش درخواست مشتری:رد درخواست
	}
	% id
	{1.9}
	% brief description
	...
	% table name
	{
		روند جایگزین: پذیرش درخواست: رد درخواست
	}
}
...
% table name
{
روند جایگزین: پذیرش خدمت: رد خدمت
}
}
...
\cancelAlternativeFlow{ثبت سفارش خدمات}{مشتری}{1}{}
}
